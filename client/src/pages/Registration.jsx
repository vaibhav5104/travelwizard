                        ...
                        <div className="p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="group">
                                    ...
                                    <p className="mt-2 text-xs text-gray-400">Password must be at least 8 characters</p>
                                </div>
                            ...
                            <div className="mt-6">
                                <div className="relative">
                                    ...
                                    <div className="relative flex justify-center text-sm">
                                        <span className="px-4 bg-gray-800 text-gray-200 font-medium">Or join with</span>
                                    </div>
                                </div>
                            ...
                            <div className="mt-8 text-center">
                                <div className="text-sm">
                                    <span className="text-gray-400">Already exploring with us?</span>{" "}
                                    <button
