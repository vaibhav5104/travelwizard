...
const FriendsPage = () => {
  ...
  return (
      <div className="  h-max bg-gradient-to-br from-indigo-100 via-amber-200 to-pink-600 p-4">
        {/* Decorative elements */}
        
        {/* Content */}
        <div className=" mx-auto mt-6 backdrop-blur-sm bg-purple-400 bg-opacity-80 rounded-xl shadow-xl overflow-hidden border border-purple-400 border-opacity-30 relative z-10">
          {/* Header */}
